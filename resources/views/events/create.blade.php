        ...
        <form action="#" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white p-6 rounded-3xl border border-gray-400 shadow-sm group hover:border-green-400 transition-colors cursor-pointer relative">
                        <div class="absolute top-4 left-4 z-10">
                            <span class="bg-white/90 backdrop-blur px-3 py-1 rounded-md text-xs font-bold text-gray-700 border border-gray-400 shadow-sm">
                                Banner Kegiatan
                            </span>
                        </div>
                        <div class="border-2 border-dashed border-gray-400 bg-gray-50 rounded-2xl h-64 flex flex-col items-center justify-center text-center group-hover:bg-green-50/30 group-hover:border-green-400 transition-all">
                    ...
                    <div class="bg-white p-8 rounded-3xl border border-gray-400 shadow-sm">
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <input type="text" placeholder="Contoh: Mengajar Bahasa Inggris untuk Anak Jalanan" 
                                    class="w-full px-4 py-3 bg-white border border-gray-400 focus:border-green-500 focus:ring-2 focus:ring-green-200 rounded-xl transition shadow-sm text-gray-800 placeholder-gray-400">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <div class="relative">
                                        <select class="w-full px-4 py-3 bg-white border border-gray-400 focus:border-green-500 focus:ring-2 focus:ring-green-200 rounded-xl transition shadow-sm appearance-none cursor-pointer text-gray-700">
                                ...
                                <div>
                                    ...
                                    <input type="number" placeholder="0" 
                                        class="w-full px-4 py-3 bg-white border border-gray-400 focus:border-green-500 focus:ring-2 focus:ring-green-200 rounded-xl transition shadow-sm text-gray-700">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea rows="6" placeholder="Ceritakan tentang kegiatan ini dan apa saja tugas relawan..." 
                                    class="w-full px-4 py-3 bg-white border border-gray-400 focus:border-green-500 focus:ring-2 focus:ring-green-200 rounded-xl transition shadow-sm resize-none text-gray-700"></textarea>
                    ...
                    <div class="bg-white p-8 rounded-3xl border border-gray-400 shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                            <div>
                                ...
                                <input type="datetime-local" class="w-full px-4 py-3 bg-white border border-gray-400 focus:border-green-500 focus:ring-2 focus:ring-green-200 rounded-xl transition shadow-sm text-gray-600">
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" placeholder="Masukkan nama jalan, gedung, atau kota..." 
                                    class="w-full pl-11 pr-4 py-3 bg-white border border-gray-400 focus:border-green-500 focus:ring-2 focus:ring-green-200 rounded-xl transition shadow-sm text-gray-700">
                            </div>
                        </div>
                    </div>
